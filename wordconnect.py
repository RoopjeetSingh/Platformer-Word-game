...
list_images = {"a": py.image.load("./hellop/im.png"), "b": py.image.load("./hellop/b.png"),"c":py.image.load("./hellop/images (1).png"),"d": py.image.load("./hellop/d.png"), "e":py.image.load("hellop/6422859.png")}
coord = []
entered = []
correct_words = ["dabc"]
word = ""
...
while run:
    ...
    if word in correct_words:
        ...
        word = ""
        entered = []
    elif len(word) == len(letters) and word not in correct_words:
