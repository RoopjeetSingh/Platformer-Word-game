...
one_star_list = []
two_star_list = []
three_star_list = ["Great job! You are a real Future Business Leader of America!!", "You are a G.O.A.T"]
...
def celebration(score):
    if score >= 15:
        blit_text(screen, "Great job! You are a real Future Business Leader of America!!", (520, 240),
                  py.font.Font(None, 50), 650)
    elif 15 > score:
        blit_text(screen, "Try better, I know you can do this", (520, 250), py.font.Font(None, 50), 650)
            ...
            if working == True:
                ...
                if ev.type == MOUSEBUTTONDOWN:
                    ...
                    if on == True and 300 < mouse[0] < 700 and 25 < mouse[
                        1] < 475 and not pressed and clock.tick() > 100:
                        game_started = True
